...
namespace bi130168d.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public HttpStatusCodeResult Payment(string clientid, string status, decimal enduserprice, long amount, String errormessage)
        {
            ...
            if (status == "success")
            {
                ...
                ApplicationUser user = db.Users.Find(clientid);
                ...
                user.Tokens = (int)(user.Tokens + order.Tokens);
        ...
        /*      [HttpGet]
              [AllowAnonymous]
              public HttpStatusCodeResult Payment(string clientid, string status, decimal enduserprice, long amount)
              {
                  if (status == "success")
                  {
                      Order order = new Order();
        ...
        public static void sendMail(string email)
        {
            ...
            mail.From = new MailAddress("isivesa123@gmail.com", "WebPortal");
            mail.To.Add(email);
            mail.Subject = "Order Successfull";
            mail.Body = "Your payment has been processed and your order is complete. Tokens are added to your account.";
